...
const resolveImage = (imageUrl) => {
  ...
  if (typeof imageUrl !== "string") return "/no-image.png";
  ...
  return (
    <>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <Text type="secondary">Quản lý danh sách sản phẩm linh kiện điện lạnh</Text>
      </div>
      ...
      {/* ===== ADD PRODUCT MODAL ===== */}
      <AddProduct open={openAdd} onClose={() => setOpenAdd(false)} onSuccess={fetchProducts} />
    </>
  );
};
